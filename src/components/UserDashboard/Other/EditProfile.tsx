...
function EditProfile({setEdit}: Props) {
  return (
                ...
                <div className='flex flex-wrap -mx-3 mb-6'>
                    ...
                    <div className="personal w-full border-t border-gray-400 pt-4">
                        ...
                        <div className="flex justify-between">
                            ...
                            <button className="appearance-none bg-gray-200 text-gray-900 px-2 py-1 shadow-sm border border-gray-400 rounded-md mr-3" onClick={()=>{
                                setEdit(false);
                            }} >Go Back</button>
