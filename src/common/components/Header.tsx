      ...
      <header className="bg-white">
        <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
          ...
          <div className='hidden lg:flex lg:flex-1 lg:justify-center space-x-10'>
            ...
            <Link to={`/study_material`} className="text-xl font-semibold leading-6 text-gray-900">
              Resource
            </Link>
            {login ? <Link to={'/addProduct'} className="text-xl font-semibold text-gray-900" >
              <button className='bg-purple-500 p-1 text-white -mt-1 rounded-lg' >Add__Product</button>
            </Link> :
              <>
              </>}
